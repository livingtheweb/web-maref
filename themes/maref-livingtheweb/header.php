		...
		<div class="float-left navbar-brand">
			...
			?>
				...
				<div class="nav-redes">	
					...
					<a href="https://ar.linkedin.com/company/maref-group" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/images/linkedin.svg" class="mr-2" alt=""></a>
					<a href="https://www.youtube.com/channel/UCbVVGB0f5XatF4UDd4M2Vhw" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/images/youtube.svg" class="mr-2" alt=""></a>
