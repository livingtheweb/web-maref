...
<div id="primary">
    ...
    <section id="control-solidos" class="section-p60 bg-general">
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
            <h2 class="font-weight-bold text-blue text-center display-4 mb-5">Sistema de control de sólidos</h2>         
          </div>
          <div class="mx-4"></div>
          <div class="row">
            ...
            <div class="col-lg-7">    
              <div class="row">
                <div class="col-lg-12">                   
                  <img src="<?php echo site_url(); ?>/wp-content/uploads/2020/07/ucs-1.jpg" alt="">  
                  <hr>
                </div>
                
                <div class="col-lg-8">
                  <img src="<?php echo site_url(); ?>/wp-content/uploads/2020/07/ucs-2.jpg" alt="">  
                </div>
                <div class="col-lg-4" style="background-image:url(<?php echo site_url(); ?>/wp-content/uploads/2020/07/ucs-3.jpg); background-repeat:no-repeat;background-position:center center; background-size:cover"></div>
